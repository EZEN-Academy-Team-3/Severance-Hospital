                ...
                <div className="agreement">
                  ...
                  <div className="custom-scroll">
                    <div className="agree_content">
                      ...
                      <ol className="agree_num">
                        <li>
                          ...
                          <ol>
                            ...
                            <li>
                              4. “가입”이라 함은 사이트에서 제공하는 신청서 양식에
                              해당 정보를 기입하고, 본 약관에 동의하여 서비스
                              이용계약을 완료시키는 행위{" "}
                            </li>
                            <li>
                              5. “계정(ID)”이라 함은 회원의 식별과 서비스 이용을
                              위하여 회원이 선정하고 의료원이 부여하는 문자, 숫자
                              또는 특수문자의 조합을 의미합니다.{" "}
                            </li>
                            <li>
                              6. “계정정보“라 함은 회원의 계정, 비밀번호, 성명 등
                              회원이 의료원에 제공한 일반정보 및 병원등록번호등을
                              통칭합니다.{" "}
                            </li>
                            <li>
                              7. “비밀번호”라 함은 회원이 부여받은 계정과 일치되는
                              회원임을 확인하고 회원의 정보 및 권익보호를 위해
                              회원 자신이 선정하여 비밀로 관리하는 문자, 숫자 또는
                              특수문자의 조합을 의미합니다.{" "}
                            </li>
                            <li>
                            ...
                            <li>
                              9. “민감정보”라 함은 건강에 관한 정보를 의미합니다.{" "}
                            </li>
                            <li>
                              10. “탈퇴(해지)”라 함은 회원이 이용계약을 종료시키는
                              행위{" "}
                            </li>
                          </ol>
                        </li>
                      ...
                      <ol className="agree_num">
                        <li>
                          ① 상호 및 소재지 주소(회원의 불만을 처리할 수 있는 곳의
                          주소를 포함한다){" "}
                        </li>
                        <li>② 전화번호 </li>
                      ...
                      <ol className="agree_num">
                        ...
                        <li>
                          ② "의료원"은 그 변경될 서비스의 내용 및 제공일자를 제5조
                          제5항에서 정한 방법으로 이용자에게 통지하고, 제4조에서
                          정한 서비스를 변경하여 제공할 수 있습니다.{" "}
                        </li>
                        <li>
                          ③ "의료원"은 서비스 내용의 변경으로 인하여 이용자가 입은
                          손해에 대하여 배상하지 아니합니다. 단, 병원의 고의 또는
                      ...
                      <ol className="agree_num">
                        <li>
                          ① 의료원은 이 약관의 내용을 회원이 알 수 있도록 사이트의
                          초기 서비스화면(전면)에 게시하거나 연결화면을 제공하는
                          방법으로 회원에게 공지합니다.{" "}
                        </li>
                        <li>
                          ② 의료원은 회원이 의료원과 이 약관의 내용에 관하여 질의
                          및 응답을 할 수 있도록 조치를 취합니다.{" "}
                        </li>
                        <li>
                          ③ 의료원은 서비스를 이용하고자 하는 자(이하 “이용자”라
                          한다)가 약관의 내용을 쉽게 알 수 있도록 작성하고 약관에
                          동의하기에 앞서 약관에 정하여져 있는 내용 중
                          계약해제ㆍ해지, 의료원의 면책사항 및 회원에 대한
                          피해보상 등과 같은 중요한 내용을 회원이 쉽게 이해할 수
                          있도록 굵은 글씨 등으로 처리하거나 별도의 연결화면 또는
                          팝업화면 등을 제공하고 이용자의 동의를 얻도록 합니다.{" "}
                        </li>
                        <li>
                          ④ 의료원은 「약관의 규제에 관한 법률」,
                          「개인정보보호법」등 관련 법령에 위배하지 않는 범위에서
                          이 약관을 개정할 수 있습니다.{" "}
                        </li>
                        <li>
                          ⑤ 의료원이 약관을 개정할 경우에는 적용일자 및 개정내용,
                          개정사유 등을 명시하여 그 적용일자로부터 최소한 7일
                          이전(회원에게 불리하거나 중대한 사항의 변경은 30일
                          이전)부터 그 적용일자 경과 후 상당한 기간이 경과할
                          때까지 초기화면 또는 초기화면과의 연결화면을 통해
                          공지합니다.{" "}
                        </li>
                        <li>
                          ⑥ 의료원은 약관을 개정할 경우에는 개정약관 공지 후
                          개정약관의 적용에 대한 회원의 동의 여부를 확인합니다.
                          개정약관 공지시 회원이 동의 또는 거부의 의사표시를 하지
                          않으면 승낙한 것으로 간주하겠다는 내용도 함께 공지한
                          경우에는 회원이 약관 시행일까지 거부의사를 표시하지
                      ...
                      <ol className="agree_num">
                        ...
                        <li>
                          ...
                          <ol>
                            ...
                            <li>
                              4. 대한민국 이외의 국가 중 의료원에서 아직 서비스를
                              제공할 것으로 결정하지 않은 국가에서 서비스를
                              이용하는 경우로 의료원이 해외 서비스 업체와 체결한
                              계약이나 특정 국가에서 접속하는 회원에 대한 서비스
                              제공과 관련하여 서비스 제공을 제한할 필요가 있는
                              경우{" "}
                            </li>
                            <li>
                              5. 「개인정보보호법」, 「의료법」 및 그 밖의 관계
                              법령에서 금지하는 위법행위를 할 목적으로 이용신청을
                              하는 경우{" "}
                            </li>
                            <li>
                        ...
                        <li>
                          ③ 의료원은 다음 각 호의 어느 하나에 해당하는 경우에는 그
                          사유가 해소될 때까지 승낙을 유보할 수 있습니다.
                          <ol>
                            <li>
                              1. 의료원의 설비에 여유가 없거나 기술적 장애가 있는
                              경우{" "}
                            </li>
                            <li>
                              2. 서비스 상의 장애 또는 서비스의 결제수단의 장애가
                              발생한 경우{" "}
                            </li>
                            <li>
                      ...
                      <ol className="agree_num">
                        ...
                        <li>
                          ② 의료원은 계정정보를 통하여 당해 회원의 서비스 이용가능
                          여부 등의 제반 회원 관리업무를 수행합니다.{" "}
                        </li>
                        <li>
                      ...
                      <ol className="agree_num">
                        ...
                        <li>
                          ...
                          온라인으로 수정을 하거나 기타 방법으로 의료원에 대하여
                          그 변경사항을 알려야 합니다.{" "}
                        </li>
                        <li>
                      ...
                      <ol className="agree_num">
                        <li>
                          ...
                          개인정보의 보호 및 사용에 대해서는 관계법령 및 의료원이
                          별도로 고지하는 개인정보처리방침이 적용됩니다.{" "}
                        </li>
                        <li>
                          ② 서비스의 일부로 제공되는 개별 서비스를 제외한 것으로서
                          홈페이지 및 서비스별 웹사이트에서 단순히 링크된 제3자
                          제공의 서비스에 대하여는 의료원의 개인정보처리방침이
                          적용되지 않습니다.{" "}
                        </li>
                        <li>
                      ...
                      <ol className="agree_num">
                        <li>
                          ① 의료원은 관련 법령을 준수하고, 이 약관이 정하는 권리의
                          행사와 의무의 이행을 신의에 따라 성실하게 합니다.{" "}
                        </li>
                        <li>
                          ② 의료원은 회원이 안전하게 서비스를 이용할 수 있도록
                          개인정보(신용정보 포함)보호를 위해 보안시스템을 갖추어야
                          하며 개인정보처리방침을 공시하고 준수합니다. 의료원은 이
                          약관 및 개인정보처리방침에서 정한 경우를 제외하고는
                          회원의 개인정보가 제3자에게 공개 또는 제공되지 않도록
                          합니다.{" "}
                        </li>
                        <li>
                          ...
                          불가능한 결함 및 장애 등 부득이한 사유가 없는 한 지체
                      ...
                      <ol className="agree_num">
                        <li>
                          ...
                          <ol>
                            ...
                            <li>
                              7. 의료원과 기타 제3자의 저작권 등 지적재산권에 대한
                              침해{" "}
                            </li>
                            <li>
                              8. 의료원 및 기타 제3자의 명예를 손상시키거나 업무를
                              방해하는 행위{" "}
                            </li>
                            <li>
                      ...
                      <ol className="agree_num">
                        <li>
                          ① 회원은 의료원이 제공하는 서비스를 이 약관, 운영정책 및
                          의료원이 설정한 규칙에 따라 이용할 수 있습니다.{" "}
                        </li>
                        <li>
                      ...
                      <ol className="agree_num">
                        <li>
                          ...
                          <ol>
                            ...
                            <li>
                              3. 천재지변, 비상사태, 정전, 서비스 설비의 장애 또는
                              서비스 이용의 폭주 등으로 정상적인 서비스 제공이
                              불가능할 경우{" "}
                            </li>
                          </ol>
                        </li>
                        <li>
                          ...
                          서비스를 중지할 수 있습니다. 이 경우 의료원은 그 사실을
                          회원에게 초기 화면이나 홈페이지에 고지합니다.{" "}
                        </li>
                        <li>
                          ③ 제1항 제2호의 경우, 의료원은 사전 고지 없이 서비스를
                          일시 중지할 수 있습니다. 의료원은 이러한 경우 그 사실을
                          초기 화면이나 홈페이지에 사후 고지할 수 있습니다.{" "}
                        </li>
                        <li>
                          ④ 의료원은 의료원이 제공하는 서비스 이용과 관련하여
                          이용자에게 발생한 어떠한 손해에 대해서도 책임을 지지
                          않습니다. 다만, 의료원의 고의 또는 중대한 과실로 인하여
                          발생한 손해의 경우는 제외합니다.{" "}
                        </li>
                      </ol>
                      <h5>제16조 (정보의 제공) </h5>
                      ...
                      <ol className="agree_num">
                        <li>
                          ...
                          할 것이며, 본 정보는 의료원만이 보유하고 법령으로 권한을
                          부여 받지 아니한 제3자는 절대로 열람할 수 없습니다.{" "}
                        </li>
                        <li>
                          ② 의료원은 서비스 운영 및 프로그램 안정화 등 서비스 품질
                          개선을 위하여 회원 PC 등 단말기 설정 및 사양 정보를
                          수집•활용할 수 있습니다.{" "}
                        </li>
                      </ol>
                      ...
                      <ol className="agree_num">
                        ...
                        <li>
                          ...
                          정보를 의료원 또는 제공업체의 사전승낙 없이 복제, 전송,
                          출판, 배포, 방송 기타 방법에 의하여 영리목적으로
                          이용하거나 제3자에게 이용하게 하여서는 안 됩니다.{" "}
                        </li>
                        <li>
                          ③ 의료원은 회원이 게시하거나 등록하는 서비스 내의
                          게시물, 게시 내용에 대해 제 13조에서 규정하는 금지행위에
                          해당된다고 판단되는 경우, 사전통지 없이 이를 삭제하거나
                          이동 또는 등록을 거부할 수 있습니다.{" "}
                        </li>
                        <li>
                          ④ 의료원이 운영하는 게시판 등에 게시된 정보로 인하여
                          법률상 이익이 침해된 회원은 의료원에게 당해 정보의 삭제
                          또는 반박내용의 게재를 요청할 수 있습니다. 이 경우
                          의료원은 신속하게 필요한 조치를 취하고, 이를 신청인에게
                          통지합니다.{" "}
                        </li>
                      </ol>
                      ...
                      <ol className="agree_num">
                        <li>
                          ...
                          의료원은 회원 본인 여부를 확인할 수 있으며, 해당 회원이
                          본인으로 확인되는 경우에 회원의 신청에 따른 조치를
                          취합니다.{" "}
                        </li>
                        <li>
                      ...
                      <ol className="agree_num">
                        <li>
                          ① 의료원은 회원이 이 약관에서 정한 회원의 의무를 위반한
                          경우에는 회원에 대한 사전 통보 후 계약을 해지할 수
                          있습니다. 다만, 회원이 현행법 위반 및 고의 또는 중대한
                          과실로 의료원에 손해를 입힌 경우에는 사전 통보 없이
                          이용계약을 해지할 수 있습니다.{" "}
                        </li>
                        <li>
                      ...
                      <ol className="agree_num">
                        ...
                        <li>
                          ...
                          이용을 재개합니다 다만, 제1항에 의한 위법행위자로 판명된
                          경우에는 그러하지 아니합니다.{" "}
                        </li>
                      </ol>
                      ...
                      <ol className="agree_num">
                        <li>
                          ...
                          제반사정을 고려하여 이용제한이 이루어지는 구체적인 사유
                          및 절차를 운영정책으로 정합니다.{" "}
                        </li>
                        <li>
                      ...
                      <ol className="agree_num">
                        <li>
                          ① 회원이 의료원의 이용제한에 불복하고자 할 때에는 통보를
                          받은 날로부터 15일 이내에 의료원의 이용제한에 불복하는
                          이유를 기재한 이의신청서를 서면, 전자우편 또는 이에
                          준하는 방법으로 의료원에 제출하여야 합니다.{" "}
                        </li>
                        <li>
                        ...
                        <li>
                          ③ 의료원은 위 답변 내용에 따라 상응하는 조치를 취하여야
                          합니다.{" "}
                        </li>
                      </ol>
                      <h5>제25조 (양도금지) </h5>
                      ...
                      <ol className="agree_num">
                        <li>
                          ① 의료원이 고의 또는 중과실로 회원에게 손해를 끼친 경우,
                      ...
                      <ol className="agree_num">
                        ...
                        <li>
                          ③ 의료원은 기간통신 사업자가 전기통신서비스를 중지하거나
                          정상적으로 제공하지 아니하여 회원에게 손해가 발생한
                          경우에 대해서 의료원의 고의 또는 중대한 과실이 없는 한
                          책임이 면제됩니다.{" "}
                        </li>
                        <li>
                        ...
                        <li>
                          ...
                          문제 또는 의료원의 고의 또는 중대한 과실이 없는 네트워크
                          환경으로 인하여 발생하는 문제에 대해서 책임이
                          면제됩니다.{" "}
                        </li>
                        <li>
                          ⑥ 의료원은 회원 또는 제3자가 서비스 내 또는 웹사이트
                          상에 게시 또는 전송한 정보, 자료, 사실의 신뢰도, 정확성
                          등의 내용에 대해서는 의료원의 고의 또는 중대한 과실이
                          없는 한 책임이 면제됩니다.{" "}
                        </li>
                        <li>
                        ...
                        <li>
                          ⑨ 의료원은 회원의 컴퓨터 오류에 의한 손해가 발생한 경우
                          또는 신상정보 및 전자우편주소를 부정확하게 기재하거나
                          미기재하여 손해가 발생한 경우에 대하여 의료원의 고의
                      ...
                      <ol className="agree_num">
                        <li>
                          ① 의료원은 회원의 편의를 고려하여 회원의 의견이나 불만을
                          제시하는 방법을 초기화면이나 홈페이지에서 안내합니다.
                          의료원은 이러한 회원의 의견이나 불만을 처리하기 위한
                          전담조직을 운영합니다.{" "}
                        </li>
                        <li>
                          ② 의료원은 회원으로부터 제기되는 의견이나 불만이
                          정당하다고 객관적으로 인정될 경우에는 합리적인 기간 내에
                          이를 신속하게 처리합니다. 다만, 처리에 장기간이 소요되는
                          경우에는 회원에게 장기간이 소요되는 사유와 처리일정을
                          홈페이지에 공지하거나 전자우편, 전화 또는 서면 등으로
                          통보합니다.{" "}
                        </li>
                        <li>
                          ③ 의료원과 회원간에 분쟁이 발생하여 제3의 분쟁조정기관이
                          조정할 경우 의료원은 이용제한 등 회원에게 조치한 사항을
                          성실히 증명하고, 조정기관의 조정에 따를 수 있습니다.{" "}
                        </li>
                      </ol>
                      ...
                      <ol className="agree_num">
                        ...
                        <li>
                          ...
                          의료원의 초기화면에 게시하거나 공지사항등을 제시함으로써
                          제1항의 통지에 갈음할 수 있습니다.{" "}
                        </li>
                      </ol>
                      <h5>제30조 (재판권 및 준거법) </h5>
                      <p>
                        본 약관은 대한민국 법률에 따라 규율되고 해석되며, 의료원과
                  ...
                  <div className="custom-scroll">
                    <div className="agree_content">
                      ...
                      <p>
                        ...
                        이용하는 목적은 홈페이지 회원의 가입 및 관리를 위함입니다.{" "}
                        <br />
                        의료원 산하병원(세브란스병원, 강남세브란스병원,
                        용인세브란스병원, 치과대학병원)의 홈페이지는 통합회원제로
                        운영되고 있으며, 한 번의 로그인으로 모든 사이트 이용이
                        가능합니다.
                        <br />
                        <br />
                      ...
                      <ol className="agree_num bold">
                        <li>
                          1. 진료/건강검진 예약, 예약조회 및 회원제 서비스 이용에
                          따른 본인 확인 절차에 사용
                        </li>
                      ...
                      <ul className="agree_num bold">
                        ...
                        <li>
                          ...
                          <ul>
                            <li>
                              - 필수항목 : 성명, 아이디, 비밀번호, 이메일, 연락처,
                              법정대리인 성명, 법정대리인성별, 법정대리인
                              생년월일, 법정대리인 인증(휴대폰인증/아이폰인증/범용
                              공인인증서){" "}
                            </li>
                            <li>- 선택항목 : 예비연락처 </li>
                          </ul>
                      ...
                      <p>
                        다만, 홈페이지 개선 지원을 위한 최소한의 정보인 필수항목의
                        개인정보 미제공시에는 홈페이지 회원가입이 거부될 수
                        있습니다.{" "}
                      </p>
                      <br />
                      ...
                      <p>
                        ...
                        사항(고유식별정보, 민감정보, 목적 외 이용 및 제 3자 제공,
                        마케팅목적 활용)은 가입신청서등을 통하여 각각 동의를 받은
                        후 수집합니다.{" "}
                      </p>
